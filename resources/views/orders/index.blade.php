                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex flex-col gap-1">
                                <a href="{{ route('orders.show', $order->id_pesanan) }}" class="btn btn-info btn-xs">Detail</a>
                                <a href="{{ route('orders.edit', $order->id_pesanan) }}" class="btn btn-warning btn-xs">Edit</a>
                                <form action="{{ route('orders.destroy', $order->id_pesanan) }}" method="POST"
                                    onsubmit="return confirm('Yakin ingin menghapus order ini?')">
                                    @csrf @method('DELETE')
                                    <button type="submit" class="btn btn-error btn-xs w-full">Hapus</button>
                                </form>
                            </div>
                        </td>
                    </tr>
...
<div class="card bg-base-100 shadow">
    <div class="card-body">
        <h3 class="card-title text-error">Log Penghapusan Order</h3>
        <div class="overflow-x-auto">
            <table class="table table-zebra">
                <thead>
                    <tr>
